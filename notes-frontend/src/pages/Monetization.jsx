...
export default function Monetization() {
  ...
  const [payouts, setPayouts] = useState({ total_earned: 0, entries: [] });
  ...
  const loadAll = useCallback(async () => {
    try {
      ...
      setPayouts(p.data || { total_earned: 0, entries: [] });
    } catch {
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <div className="border border-black bg-white p-6">
          ...
          <div className="space-y-3">
            ...
            <input className="input-surface" placeholder="Optional Note ID" value={couponForm.note_id} onChange={(e) => setCouponForm((p) => ({ ...p, note_id: e.target.value }))} />
        ...
        <div className="border border-black bg-white p-6">
          ...
          <div className="space-y-3">
            <input className="input-surface" placeholder="Note ID" value={campaignForm.note_id} onChange={(e) => setCampaignForm((p) => ({ ...p, note_id: e.target.value }))} />
        ...
        <div className="border border-black bg-white p-6">
          ...
          <p className="mb-4 text-2xl font-black uppercase tracking-tight text-black">INR {payouts.total_earned || 0}</p>
          <div className="max-h-64 space-y-2 overflow-y-auto">
            {(payouts.entries || []).map((e) => (
              <div key={e.id} className="border border-zinc-200 p-2 text-xs">
                ...
                <p className="font-black text-black">INR {e.amount}</p>
